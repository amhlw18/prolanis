                        ...
                        <div class="list-group-item nested-1">
                            <div class="d-flex align-items-center">
                                <div class="avatar-xs flex-shrink-0 me-3">
                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="img-fluid rounded-circle material-shadow">
                                </div>
                            ...
                            <div class="list-group nested-list nested-sortable">
                                <div class="list-group-item nested-2">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-xs flex-shrink-0 me-3">
                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="img-fluid rounded-circle material-shadow">
                                        </div>
                                        <div class="flex-grow-1">
                                    ...
                                    <div class="list-group nested-list nested-sortable">
                                        <div class="list-group-item nested-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="img-fluid rounded-circle material-shadow">
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <div class="list-group nested-list nested-sortable">
                                        <div class="list-group-item nested-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-4.jpg')); ?>" alt="" class="img-fluid rounded-circle material-shadow">
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="list-group nested-list nested-sortable">
                                                ...
                                                <div class="list-group-item nested-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-xs flex-shrink-0 me-3">
                                                            <div class="avatar-title rounded-circle">
                                                                <img src="<?php echo e(URL::asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="img-fluid rounded-circle material-shadow">
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                    ...
                                    <div class="list-group nested-list nested-sortable">
                                        <div class="list-group-item nested-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    <img src="<?php echo e(URL::asset('build/images/users/avatar-6.jpg')); ?>" alt="" class="img-fluid rounded-circle material-shadow">
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="list-group nested-list nested-sortable">
                                                <div class="list-group-item nested-4">
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar-xs flex-shrink-0 me-3">
                                                            <img src="<?php echo e(URL::asset('build/images/users/avatar-7.jpg')); ?>" alt="" class="img-fluid rounded-circle material-shadow">
                                                        </div>
                                                        <div class="flex-grow-1">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UMB\LPPSI\Applications\Template\Admin\Laravel\master\resources\views/advance-ui-nestable.blade.php ENDPATH**/ ?>