                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="dashboard-coba" class="nav-link"><?php echo app('translator')->get('translation.crm'); ?></a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="apps-peserta_prolanis" class="nav-link"> <span>Peserta Prolanis</span></a>
                            </li>
...
<?php /**PATH C:\Users\ASUS\prolanis\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>